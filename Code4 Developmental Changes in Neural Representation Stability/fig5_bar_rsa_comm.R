...
condname.colname <- c("Grp_CBD_Comm_fdr05_r00_all","Grp_CBD_Comm_fdr05_r01_fef_b","Grp_CBD_Comm_fdr05_r02_spl_b")
...
data.barfig <- ggbarplot (data.fig,                            # The data frame of results
  ...
  coord_cartesian(ylim = c(-0.03, 0.46)) +
...
# Name of the figure
fig.name <- paste("fig4_bar_rsa-comm.", fig.fmt, sep = "")
# Save figure to disk
