...
name.colname <- c("MI_c1A","c1A_wholemask") # The indicators name in the data file
name.figshow <- c("mature_c1A")                               # The indicators name will present in the figure
con.col      <- c("lightcoral")                         # The indicators color will present in the figure
