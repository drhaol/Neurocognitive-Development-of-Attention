...
condname.colname <- "A_NoDoub_mean_abs"
condname.figshow <- "Alerting"
...
fig.out <- ggplot(data = data.fig, 
  ...
  scale_y_continuous(limits=c(-80,122)) +
...
fig.out
# Name of the figure
fig.name <- paste("fig1_compare2grp_", data.grp, "-c1a.", fig.fmt, sep = "")
# Save figure to disk
