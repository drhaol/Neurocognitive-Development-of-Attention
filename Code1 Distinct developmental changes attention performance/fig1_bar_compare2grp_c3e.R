...
condname.colname <- "E_InconCon_mean_abs"
condname.figshow <- "Executive"
...
fig.out <- ggplot(data = data.fig, 
  ...
  scale_y_continuous(limits=c(-20, 155)) +
...
fig.out
# Name of the figure
fig.name <- paste("fig1_compare2grp_", data.grp, "-c3e.", fig.fmt, sep = "")
# Save figure to disk
