...
data.fig <- read.csv("data_NewSample_r1FEF.csv")
...
data.viol <- ggplot(data = data.fig, 
  ...
  scale_color_manual(values=c(rgb(107/255,75/255,147/255),rgb(107/255,75/255,147/255),
                              rgb(107/255,75/255,147/255)), name = "Group", 
...
fig.name <- paste("fig5_fef", ".", fig.fmt, sep = "")
