...
data.fig <- read.csv("data_NewSample_r4TPJ.csv")
...
data.viol <- ggplot(data = data.fig, 
  ...
  scale_color_manual(values=c(rgb(148/255,203/255,115/255),rgb(148/255,203/255,115/255),
                              rgb(148/255,203/255,115/255)), name = "Group", 
...
fig.name <- paste("fig5_tpj", ".", fig.fmt, sep = "")
