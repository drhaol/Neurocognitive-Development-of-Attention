...
data.fig <- read.csv("data_NewSample_r3Angular.csv")
...
data.viol <- ggplot(data = data.fig, 
  ...
  scale_color_manual(values=c(rgb(244/255,123/255,124/255),rgb(244/255,123/255,124/255),
                              rgb(244/255,123/255,124/255)), name = "Group", 
...
fig.name <- paste("fig5_angular", ".", fig.fmt, sep = "")
